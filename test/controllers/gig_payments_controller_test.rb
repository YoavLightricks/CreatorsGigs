...
class GigPaymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig_payment" do
    assert_difference('GigPayment.count') do
      post gig_payments_url, params: { gig_payment: { state: @gig_payment.state } }, as: :json
    end
  ...
  test "should update gig_payment" do
    patch gig_payment_url(@gig_payment), params: { gig_payment: { state: @gig_payment.state } }, as: :json
    assert_response 200
  end
