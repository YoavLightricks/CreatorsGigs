...
class GigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post gigs_url, params: { gig: { brand_name: @gig.brand_name, state: @gig.state } }, as: :json
    end
  ...
  test "should update gig" do
    patch gig_url(@gig), params: { gig: { brand_name: @gig.brand_name, state: @gig.state } }, as: :json
    assert_response 200
  end
